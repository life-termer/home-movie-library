...
<body>
	...
	<div class="w3-content w3-light-gray">
		...
		<div class="w3-row">
			...
			<div class="w3-third">
			  <a href="${addReviewLink}" class="w3-bar-item w3-button w3-dark-grey" style="width:100%">Add Review</a> 
			</div>
			</div>
			<c:forEach var="tempReview" items="${reviews}">
				...
				class="w3-bar-item w3-button w3-dark-grey w3-hover-red" style="width:50%">Delete review</a>
				</div>
			...
			<div class="w3-bar">
				<a href="${updateLink}" class="w3-bar-item w3-button w3-dark-grey" style="width:50%">Edit Movie</a> 
				<a href="${deleteLink}" onclick="if (!(confirm('Are you shure you want to delete this movie?'))) return false" 
				class="w3-bar-item w3-button w3-dark-grey w3-hover-red" style="width:50%">Delete Movie</a>
			</div>
		</div>
		</div>
